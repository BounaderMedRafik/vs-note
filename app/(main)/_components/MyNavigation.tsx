...
import MyLovelyNavBar from "./MyLovelyNavbar";
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          "group/sidebar bg-[#DDDDDD] dark:bg-[#001524] overflow-x-hidden  h-full  border-r-2 border-[#627254]/20 overflow-y-auto relative flex w-60 flex-col z-50",
      ...
      >
        ...
        <div className="mt-4">
          <MyDocumentList />
          <MyItem onClick={handleCreate} icon={Plus} label="Add page" />
          <Popover>
            <PopoverTrigger className="w-full mt-4">
              <MyItem label="Trash" icon={Trash} />
            </PopoverTrigger>
            <PopoverContent
              className="p-0 w-72"
      ...
      >
        {!!params.documentId ? (
          <MyLovelyNavBar isCollapsed={isCollapsed} onResetWidth={resetWidth} />
        ) : (
